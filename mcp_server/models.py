...
#   timestamp: 2025-06-28T15:15:40+00:00
...
class CertificateParameters(BaseModel):
    COURSE_NO: str = Field(..., description='CERTIFICATE NO', examples=['2019/65404/1'])
    FullName: str = Field(..., description='Full name', examples=['Sunil Kumar'])
    certificate_type: str = Field(
        ..., description='CERTIFICATE TYPE', examples=['NIESBUD,PMYUVA']
    )
